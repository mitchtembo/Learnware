        ...
        <Card className="p-6">
          <div className="text-center space-y-4">
            ...
            <p className="text-gray-600">
              Generate comprehensive study materials including content explanation, key points, and practice questions.
            </p>
            <Button
    ...
    return (
      <div className="space-y-6">
                ...
                <div className="mb-4">
                  ...
                  <ul className="space-y-1 pl-5 list-disc">
                    {material.keyPoints.map((point, i) => (
                      <li key={i} className="pl-1" dangerouslySetInnerHTML={{ __html: formatText(point) }} />
                    ))}
                  </ul>
                </div>
              )}
        ...
        <div className="flex justify-end">
          <Button onClick={handleGenerateStudyMaterial} disabled={generatingMaterial}>
      ...
      return (
        <Card className="p-6">
          <div className="text-center space-y-4">
            ...
            <p className="text-gray-600">Generate quiz questions to test your knowledge about this course.</p>
            <Button onClick={handleGenerateQuiz} disabled={generatingQuiz || savingData} className="w-full">
              {generatingQuiz ? (
                <>
                  <Loader2 className="w-4 h-4 mr-2 animate-spin" />
                  Generating...
                      ...
                      <div className="space-y-2 mb-4">
                        {q.options.map((option, j) => (
                          <div key={j} className="flex items-center gap-2">
                            ...
                            >
                              {option === q.correctAnswer && <Check className="h-3 w-3 text-green-500" />}
                            </div>
                            <span>{option}</span>
                          </div>
                        ))}
    ...
    <MainLayout>
      <div className="container mx-auto py-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">{course.studentsEnrolled} students</p>
                </div>
              </div>
              <div className="flex items-center gap-2">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            {!course.content && !generatingContent ? (
              <Card className="p-6">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-600">
                    Generate comprehensive course content including overview, learning objectives, key topics, and
                    prerequisites.
                  </p>
                  <Button onClick={handleGenerateContent} disabled={generatingContent || savingData} className="w-full">
                    {generatingContent ? (
                      <>
                        <Loader2 className="w-4 h-4 mr-2 animate-spin" />
                        Generating...
          ...
          <TabsContent value="materials">{renderStudyMaterials()}</TabsContent>

          <TabsContent value="quiz">{renderQuizzes()}</TabsContent>
        </Tabs>
      </div>
    </MainLayout>
  )
